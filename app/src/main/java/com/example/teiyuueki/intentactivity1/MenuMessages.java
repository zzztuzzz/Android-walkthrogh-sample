...
public class MenuMessages extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // インテントの生成
                Intent intent = new Intent(MenuMessages.this, MenuMessages.class);
                // 実行
        ...
        btnProspect.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // インテントの生成
                Intent intent = new Intent(MenuMessages.this, MenuProspects.class);
                // 実行
                startActivity(intent);
            }
        });
        ...
        btnPerson.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // インテントの生成
                Intent intent = new Intent(MenuMessages.this, MenuPersonal.class);
                // 実行
                startActivity(intent);
            }
        });
